...
const OBJECTIONS = [
    {
        ...
        win: [
            {
                summary: 'Rep reframed the price against the cost of missed deals and quantified ROI with the prospect’s own numbers.',
                excerpt: 'Prospect: Honestly, this is above what we budgeted.\nRep: Fair — can I show you what one recovered deal a month covers? You said average deal size is 40k.\nProspect: Okay, when you put it that way, the math works.',
            },
            {
                summary: 'Rep anchored on the annual plan discount and tied price to the specific features the prospect said they needed.',
                excerpt: 'Prospect: The per-seat price feels steep.\nRep: You mentioned call review eats six hours a week — the annual plan works out to less than one of those hours.\nProspect: That’s a more useful comparison, yes.',
            },
            {
                summary: 'Rep acknowledged the concern, then split the rollout into a smaller initial tier with a clear expansion path.',
                excerpt: 'Prospect: We can’t commit to this spend for the whole team.\nRep: Then let’s not — start with the five reps on enterprise deals and expand when the numbers prove out.\nProspect: A pilot tier we can grow into would get approved.',
            },
        ],
        lose: [
            {
                summary: 'Rep immediately offered a discount without exploring the underlying concern, which weakened the value story.',
                excerpt: 'Prospect: That’s more than we wanted to spend.\nRep: I can knock 20% off if you sign this quarter.\nProspect: If there’s already 20% slack in the price, what else is negotiable?',
            },
            {
                summary: 'Rep repeated the feature list instead of addressing budget, and the prospect disengaged.',
                excerpt: 'Prospect: The price is the issue, not the features.\nRep: But you also get the analytics module, the coaching dashboards…\nProspect: Right, but none of that changes our budget.',
            },
            {
                summary: 'Rep deflected the pricing question to a follow-up email and never tied price to value on the call.',
                excerpt: 'Prospect: Can you justify the cost versus what we do today?\nRep: I’ll send over a pricing one-pager after the call.\nProspect: …okay. We’ll look when we get a chance.',
            },
        ],
    },
    {
        ...
        win: [
            {
                summary: 'Rep leaned into proof instead of brand: named two comparable customers and offered a reference call.',
                excerpt: 'Prospect: We’ve never heard of you — we were expecting Gong or Chorus.\nRep: Fair. Two teams your size, Meridian and Brightline, switched last year — happy to set up a reference call.\nProspect: A reference would actually help.',
            },
            {
                summary: 'Rep converted the size concern into an advantage — direct access to the founding team and faster turnaround.',
                excerpt: 'Prospect: How do we know you’ll still be around in two years?\nRep: You get our founding engineers in your Slack — when Meridian asked for SSO, it shipped in three weeks.\nProspect: That kind of attention is hard to get from the big vendors.',
            },
        ],
        lose: [
            {
                summary: 'Rep got defensive about company size and argued with the prospect rather than offering proof.',
                excerpt: 'Prospect: You’re a small unknown vendor.\nRep: We’re actually growing really fast, that’s not a fair characterization.\nProspect: It’s not about fair — it’s about risk for us.',
            },
            {
                summary: 'Rep ignored the trust concern entirely and pushed for the next meeting.',
                excerpt: 'Prospect: Nobody on our team has heard of your product.\nRep: So shall we get the technical demo scheduled for Thursday?\nProspect: Let’s hold off on scheduling anything.',
            },
        ],
    },
    {
        ...
        win: [
            {
                summary: 'Rep agreed the timing was tight and proposed starting data collection now so launch lands after the quarter closes.',
                excerpt: 'Prospect: This quarter is chaos — we can’t take on a rollout.\nRep: Don’t roll out now. Start ingesting calls quietly this month, and your team onboards in week one of next quarter with data already there.\nProspect: Starting passive collection now actually makes sense.',
            },
            {
                summary: 'Rep tied the start date to the prospect’s stated hiring plan, making delay the costlier option.',
                excerpt: 'Prospect: Maybe next half, honestly.\nRep: You said five new reps start in March — coaching them from day one beats retraining them in June.\nProspect: True, ramping them right the first time matters.',
            },
        ],
        lose: [
            {
                summary: 'Rep accepted the delay without exploring it and asked to "circle back next quarter".',
                excerpt: 'Prospect: Now’s not a great time.\nRep: No problem, I’ll circle back next quarter.\nProspect: Sure, reach out then.',
            },
        ],
    },
    {
        ...
        win: [
            {
                summary: 'Rep narrowed the comparison to the one capability the prospect cared about and proposed a side-by-side on their own calls.',
                excerpt: 'Prospect: We’re also looking at Gong.\nRep: Good tool. For rep-vs-transcript verification — the thing you said burned you last audit — run both on the same ten calls and compare.\nProspect: A bake-off on our own calls is fair.',
            },
        ],
        lose: [
            {
                summary: 'Rep disparaged the competitor, which made the prospect defend their shortlist.',
                excerpt: 'Prospect: How do you compare to Chorus?\nRep: Honestly their analysis is pretty shallow, most teams regret it.\nProspect: Our sister company uses Chorus and likes it, so…',
            },
            {
                summary: 'Rep gave a generic "we’re different" answer with no specifics tied to the prospect’s needs.',
                excerpt: 'Prospect: What makes you different from the others we’re seeing?\nRep: We really focus on the customer and our AI is next-level.\nProspect: That’s what every vendor this week has said.',
            },
        ],
    },
    {
        ...
        win: [
            {
                summary: 'Rep helped the prospect find an existing budget line (QA tooling) the purchase could legitimately sit under.',
                excerpt: 'Prospect: There’s simply no budget line for this.\nRep: Where does call QA spend sit today — the enablement budget? This usually replaces part of that line, not adds to it.\nProspect: Under enablement… that could actually work.',
            },
        ],
        lose: [
            {
                summary: 'Rep pushed the close anyway, and the prospect ended the conversation.',
                excerpt: 'Prospect: We have zero budget until the new fiscal year.\nRep: Could you sign now with a deferred start, though? Quarter end is coming.\nProspect: That’s not how our finance team works. We should stop here.',
            },
        ],
    },
    {
        ...
        win: [
            {
                summary: 'Rep turned the approval step into a joint plan — built the business case with the champion and got invited to the VP meeting.',
                excerpt: 'Prospect: I’d need my VP to sign off.\nRep: What does she care about most — risk, cost, or rep ramp time? Let’s build the one-pager around that and I’ll join you for the questions I should answer.\nProspect: Bring the compliance angle, that’s her hot button.',
            },
        ],
        lose: [
            {
                summary: 'Rep left the approval entirely to the prospect with no materials or follow-up plan.',
                excerpt: 'Prospect: I’ll have to run this up the chain.\nRep: Great, let me know how it goes!\nProspect: Will do… (no next step was set)',
            },
        ],
    },
    {
        ...
        win: [
            {
                summary: 'Rep walked through the existing dialer integration and offered a sandbox to de-risk the setup.',
                excerpt: 'Prospect: Our stack is a mess — integrations always blow up.\nRep: You’re on RingCentral, right? That connector is native — I can spin up a sandbox against a test workspace today.\nProspect: If we can verify in a sandbox first, that removes most of my worry.',
            },
        ],
        lose: [
            {
                summary: 'Rep hand-waved the integration effort without specifics, and the concern remained open.',
                excerpt: 'Prospect: How painful is setup with our phone system?\nRep: It’s usually pretty easy, our team handles it.\nProspect: “Usually” is what the last vendor said too.',
            },
        ],
    },
];
function pickHandling(score, difficulty) {
...
async function main() {
    ...
    const uuidId = { _id: { type: String, default: () => (0, node_crypto_1.randomUUID)() } };
    const opts = { strict: false, timestamps: true };
    const Company = mongoose_1.default.model('Company', new mongoose_1.default.Schema(uuidId, opts));
    const User = mongoose_1.default.model('User', new mongoose_1.default.Schema(uuidId, opts));
    const Call = mongoose_1.default.model('Call', new mongoose_1.default.Schema(uuidId, opts));
    const CallAnalysis = mongoose_1.default.model('CallAnalysis', new mongoose_1.default.Schema(uuidId, opts));
    const ComparisonResult = mongoose_1.default.model('ComparisonResult', new mongoose_1.default.Schema(uuidId, opts));
    ...
    if (existing > 0) {
        console.log(`Found ${existing} seeded calls already — run with --clean first to reseed.`);
        await mongoose_1.default.disconnect();
        return;
    }
    const now = Date.now();
    ...
    for (const profile of REPS) {
        ...
        for (let i = 0; i < callCount; i++) {
            ...
            const score = Math.round(Math.max(5, Math.min(99, profile.base + profile.slope * ((90 - daysAgo) / 7) + between(-14, 14))));
            const complianceIssues = rand() < 0.22
            ...
            await CallAnalysis.create({
                ...
                parsedOutput: {
                    ...
                    score,
                    whatWasDone: [],
                    whatWentWell: sample(GOOD_POINTS, Math.ceil(between(1, 3))).map((point) => ({ point, evidence: 'See transcript excerpt.' })),
                    areasForImprovement: sample(IMPROVEMENT_POINTS, Math.ceil(between(1, 3))).map((point) => ({ point, suggestion: 'Coach in next 1:1.' })),
                    redFlags: rand() < 0.35
            ...
            const alignment = Math.round(Math.max(5, Math.min(99, profile.honesty * 100 + between(-18, 10))));
